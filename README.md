# SmilyAI OS 0.3 — Platinum preview
...
**Release status: source-tested preview. No bootable binary was built or boot-tested
in the authoring environment. Do not treat this kit as a certified daily-driver OS.**
...
- [Recorded automated test output](docs/TEST_RESULTS.txt)

## Development on an existing Linux desktop

Requires Python 3.11+, Node.js 20+ for tests, Chromium and curl for the UI.
...
- `dist/SmilyAI-OS-0.3.0-x86_64.iso` — Debian Live hybrid ISO definition, BIOS + UEFI, graphical Debian installer.
- `dist/SmilyAI-OS-0.3.0-rpi-arm64.img.xz` — pi-gen ARM64 definition, Pi 4/5 firmware and hardware packages.
